...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "todaysong.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_TABLE = "CREATE TABLE " + Contract.ContactEntry.TABLE_NAME + " ("
                ...
                + Contract.ContactEntry.COLUMN_ARTIST + " TEXT NOT NULL, "
                + Contract.ContactEntry.COLUMN_TYPEOFGENRES + " TEXT NOT NULL, "
